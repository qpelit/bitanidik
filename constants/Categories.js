const categories = [
    ...
    { label: 'Danışmanlık',value:'7',key:'7',iconName:'comment-dots',color:'#45aaf2' }, 
    { label: 'Özel Gün',value:'8',key:'8',iconName:'grin-hearts' ,color:'#eb3b5a'}, 
    { label: 'Diğer',value:'9',key:'9',iconName:'question-circle',color:'#778ca3'},
  ];
export default {
    categories
};
